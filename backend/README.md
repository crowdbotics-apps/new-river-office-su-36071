...
## Project Structure
    ...
    ├── new_river_office_su_36071  # Django project configurations
...
1. Clone this repo and `cd new_river_office_su_36071`
...
2. Clone this repo and `cd new_river_office_su_36071`
